@{
    ...
    CmdletsToExport      = @('Get-AppInstallItem', 'Get-AppInstallerApp', 'Get-AppInstallSettings', 'Get-InstalledApplications', 'Get-ServiceProcess', 'Get-SubstDrive', 'New-AppInstallContext', 'New-SubstDrive', 'Remove-SubstDrive', 'Update-AppInstallerApp')
    VariablesToExport    = @()
    AliasesToExport      = @()
