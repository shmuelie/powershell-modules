...
| [Shmuelie.PackageManagement](modules.md#shmuelie-packagemanagement) | Provider-neutral package updates; see the module README for available integrations | 0.1.0 |
