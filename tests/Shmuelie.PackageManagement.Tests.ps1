...
Describe 'PackageManagement foundation surface' {
    ...
    It 'reports unavailable providers in stable catalog order without importing dependencies' {
        ...
        Mock Get-PackageProviderAvailability -ModuleName Shmuelie.PackageManagement {
            [pscustomobject]@{ Available = $false; Reason = 'Unavailable in this test.' }
        }
        ...
        foreach ($result in $results) {
            ...
            $result.Reason | Should -BeExactly 'Unavailable in this test.'
